...
# Dracular colorscheme
declare -A TRUELINE_COLORS_DEFAULT=(
    [black]='40;42;54'
    [cursor_grey]='68;71;90'
    [green]='80;250;123'
    [grey]='148;163;165'
    [light_blue]='139;233;253'
    [mono]='98;114;164'
    [orange]='255;184;108'
    [purple]='189;147;249'
    [pink]='255;121;198'
...
if [[ "${#TRUELINE_SEGMENTS[@]}" -eq 0 ]]; then
    declare -a TRUELINE_SEGMENTS=(
        'user,black,purple,bold'
        'venv,black,pink,bold'
        # 'conda_env,black,purple,bold'
        'git,black,green,normal'
...
# Powerline seperators: https://github.com/ryanoasis/powerline-extra-symbols
